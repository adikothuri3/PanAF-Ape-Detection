...
- The repository code licence does **not** cover the data. See
  [`../docs/obsidian/05 Technical/licensing.md`](../docs/obsidian/05%20Technical/licensing.md).
...
(see [`../docs/obsidian/05 Technical/reproducibility.md`](../docs/obsidian/05%20Technical/reproducibility.md)).
